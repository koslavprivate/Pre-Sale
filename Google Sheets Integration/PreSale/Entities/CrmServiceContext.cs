...
namespace PreSale.Properties
{
	...
	public partial class CrmServiceContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="PreSale.Properties.cr254_ProducationApplication"/> entities.
		/// </summary>
		public System.Linq.IQueryable<PreSale.Properties.cr254_ProducationApplication> cr254_ProducationApplicationSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<PreSale.Properties.cr254_ProducationApplication>();
			}
		}
	}
